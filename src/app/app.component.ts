...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet,  CommonModule, HeaderComponent, ProductListComponent],
...
export class AppComponent {
  ...
  getSelectedCategory() {
    return this.categoryService.getSelectedCategory();
  }

  deleteProduct(productId: number) {
    this.categoryService.deleteProduct(productId);
  }

  likeProduct(productId: number) {
    this.categoryService.likeProduct(productId);
  }
}
